      ...
      <form onSubmit={handleSubmit}>
            ...
            {moodOptions.map(({ value, label }) => (
              ...
              >
                <input
                  ...
                  onChange={(e) =>
                    setRecord({ ...record, mood: e.target.value as MoodLevel })
                  }
                />
                {label}
              </label>
        ...
        <div style={{ marginBottom: "25px" }}>
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    if (e.target.checked) {
                      setRecord({
                        ...record,
                        discomforts: [...discomforts, value],
                      });
                    } else {
                      setRecord({
                        ...record,
                        discomforts: discomforts.filter((d) => d !== value),
                      });
                    }
                  }}
                />
          ...
          <textarea
            ...
            onChange={(e) =>
              setRecord({ ...record, discomfortNote: e.target.value })
            }
